...
function clearAll() {
    ...
    // get the containers for each type
    const memeContainer = document.querySelector('.meme-content');
    const jokeContainer = document.querySelector('.joke-content');
    const quoteContainer = document.querySelector('.quote-content');
    const riddleContainer = document.querySelector('.riddle-content');
    
    // set the html for each container to an empty string
  ...
  */
  function showJoke() {
    ...
    clearAll();
    document.querySelector('.joke-content').appendChild(jokeP);
  }
  ...
  */
  function showRiddle() {
    ...
    // ^ creates an id for the p tag in html: <p id="riddle-answer">Answer to riddle</p>
  ...
  */
  function revealAnswers() {
    ...
    // check if there is a riddle and if the answer is hidden
    // if so reveal the answer
    if (riddle && answer.hidden) {
      answer.hidden = false;
      // alert('There is already an answer revealed :>');   
    }
    // redudant since answer must not be hidden in this block but just kept for clarity
    else if (riddle && !answer.hidden) {
      alert('Answer already revealed :>');
    }
    else{
      alert('No riddle to give answer to');
    }
  }
  ...
  */
  ...
  const memes = ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQa2NBjSWTG0BcqMKdqZ3fAcpNwf4tfMaxuyAOzPcPz1w&s', 'https://i.redd.it/q29egav34ee61.jpg', 'https://pbs.twimg.com/media/Es055BkUYAg2pRQ.jpg', 'https://www.testbytes.net/wp-content/uploads/2019/06/Untitled-8.png', 'https://miro.medium.com/max/1000/0*Ua695vjzFHV6VNOX.png', 'https://pbs.twimg.com/media/EKkPagPXkAA__Qo.jpg', 'https://code-love.com/wp-content/uploads/2019/03/download.jpeg', 'https://www.thecoderpedia.com/wp-content/uploads/2020/06/Programming-Memes-Programmer-while-sleeping.jpg', 'https://media1.tenor.com/m/wWg4VmAeTNIAAAAC/torture-dance.gif', 'https://www.thecoderpedia.com/wp-content/uploads/2020/06/Programming-Memes-Error-in-Code-896x1024.jpg', 'https://www.thecoderpedia.com/wp-content/uploads/2020/06/Coding-Meme-Code-Comments-be-Like-925x1024.jpg', 'https://www.thecoderpedia.com/wp-content/uploads/2020/06/Internet-Explorer-Joke-915x1024.jpg'];
